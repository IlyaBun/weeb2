...
// Расчет показателей
$successRate = calculateSuccessRate($pdo, $filters);
$qualityPercentage = calculateQualityPercentage($pdo, $filters);
...
$sql = "SELECT AVG(g.grade) as avg_grade 
        FROM grades g 
...
<main class="main-content">
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-content">
                <h3><?= number_format($qualityPercentage, 2) ?>%</h3>
                <p>Качество знаний</p>
            </div>
        </div>
