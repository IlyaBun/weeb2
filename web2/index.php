...
switch ($module) {
    ...
    default:
        ...
        $riskCount = count(getRiskStudents($pdo, 100));
        $qualityPercentage = calculateQualityPercentage($pdo);

        // Данные для графиков
        $gradeDistribution = getGradeDistribution($pdo);
        $groupRating = getGroupRating($pdo, 5);
        $monthlyDynamics = getMonthlyDynamics($pdo);
        ...
        <main class="main-content">
            ...
            <div class="kpi-grid">
                <div class="kpi-card">
                    <div class="kpi-icon" style="background: rgba(78, 84, 200, 0.1);">
            ...
            <div class="charts-grid">
                ...
                <div class="chart-card full-width">
                    <div class="chart-header">
                        <h3><i class="fas fa-chart-line"></i> Динамика успеваемости</h3>
                    </div>
                    <div class="chart-body">
        ...
        const monthlyDynamics = ' . json_encode($monthlyDynamics) . ';
        </script>';
