        ...
        new Chart(barChartCanvas, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: 'rgba(0, 74, 9, 0.8)',
                    borderRadius: 6,
                    barThickness: 40
                }]
            },
...
document.querySelectorAll('input, select, textarea').forEach(element => {
    element.addEventListener('change', () => {
        const formMethod = element.form?.method?.toLowerCase();

        // GET-формы используются как фильтры и не должны вызывать предупреждение
        // о несохраненных изменениях при автопереходе.
        if (formMethod === 'get') {
            return;
        }
...
console.log('%c🎓 Система оценки успеваемости ПолесГУ', 'color: #004a09; font-size: 16px; font-weight: bold;');
